        ...
        <>
            <div className="container-fluid">
                <div className="row flex-sm-column flex-md-row">
                        ...
                        <div className="col-md-6 d-flex flex-column align-items-center align-items-md-start justify-content-center my-5 fade-in-top ">
                            ...
                            <button className="botonBanner">¡Contactáme!</button>
                        </div>  
                </div>
            </div>
        </>
